    ...
    public class MappingProfile : Profile {
        public MappingProfile() {
            ...
            CreateMap<MatchRequestDto, Match>()
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => Enum.Parse(typeof(MatchStatus), src.Status, true)));
            ...
            CreateMap<PlayerExperienceRequestDto, PlayerExperience>()
                ...
                .ForMember(dest => dest.EndDate, opt => opt.MapFrom(src =>
                    string.IsNullOrEmpty(src.EndDate) ? null : (DateOnly?)DateOnly.Parse(src.EndDate, CultureInfo.InvariantCulture)));
            ...
            CreateMap<CoachExperienceRequestDto, CoachExperience>()
                ...
                .ForMember(dest => dest.EndDate, opt => opt.MapFrom(src =>
                    string.IsNullOrEmpty(src.EndDate) ? null : (DateOnly?)DateOnly.Parse(src.EndDate, CultureInfo.InvariantCulture)))
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => Enum.Parse(typeof(CoachStatus), src.Status, true)));
            ...
            CreateMap<TransactionRequestDto, Transaction>()
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => Enum.Parse(typeof(TransactionStatus), src.Status, true)));
            ...
            CreateMap<PagedList<PlayerExperience>, PagedList<PlayerExperienceResponseDto>>()
                .ConvertUsing(
                    (src, dest, context) => {
                        ...
                        return new PagedList<PlayerExperienceResponseDto>(mappedItems, src.Page, src.PageSize, src.TotalCount);
                    }
                );
            ...
            CreateMap<CoachRequestDto, Coach>()
                .ForMember(dest => dest.DateOfBirth,
                    opt => opt.MapFrom(src => DateOnly.Parse(src.DateOfBirth, CultureInfo.InvariantCulture)))
                .ForMember(dest => dest.Specialty, opt => opt.MapFrom(src => Enum.Parse(typeof(Specialty), src.Specialty, true)))
                .ForMember(dest => dest.CoachStatus, opt => opt.MapFrom(src => Enum.Parse(typeof(CoachStatus), src.CoachStatus, true)));
